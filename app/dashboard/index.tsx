...
const Dashboard = () => {
  ...
  return (
    <SafeAreaView className="bg-[#05021B] p-3 flex-1">
      <Text className="text-white text-4xl mb-2 font-extrabold">
        Hey {storeedValue?.firstName}
      </Text>
      {loading ? (
        <View className="flex-1 justify-center items-center">
          <Text className="text-white italic font-bold mb-2 text-xl">Loading..</Text>
              ...
              <View className="flex-row items-center gap-4  ">
                ...
                <View className="w-[70%]">
                  <View className="flex-row items-center justify-between">
                    <Text className="text-[#FFFFFFB2] text-base">
                      {item.source}
                    </Text>
                    <Text className="text-[#FFFFFFB2] text-base">
                      {item.date}
                  ...
                  <Text
                    className="text-[#FFFFFF] mt-1 text-xl font-bold flex-wrap"
                    ellipsizeMode="tail"
                    numberOfLines={3}
                  >
                    {item.title}
